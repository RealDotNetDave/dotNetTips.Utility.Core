...
namespace dotNetTips.Utility.Standard
{
    ...
    public class InvalidEnumTypeException : Exception
    {
        ...
        public InvalidEnumTypeException(string message, Exception innerException)
        ...
        protected InvalidEnumTypeException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
    }
