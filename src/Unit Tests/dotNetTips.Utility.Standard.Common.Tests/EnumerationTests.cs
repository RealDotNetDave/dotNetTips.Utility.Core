// ***********************************************************************
// Assembly         : dotNetTips.Utility.Standard.Common.Tests
...
namespace dotNetTips.Utility.Standard.Common.Tests
{
    ...
    public class EnumerationTests
    {
        ...
        public void GetHashCodeTest()
        {
            ...
            Assert.IsTrue(dateTimeFormat.GetHashCode() > 0);
        }
        ...
        public void ToStringTest()
        {
            ...
            Assert.IsTrue(string.IsNullOrEmpty(dateTimeFormat.ToString()) == false);
        }
